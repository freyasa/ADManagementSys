...
<div class="container">
    ...
    <form class="form-signin" action="/UserRegister">
        ...
        <div class="login-wrap">
            ...
            <input type="text" autofocus="" placeholder="Education" class="form-control" name="education">
            <div class="radios">
                <label for="radio-01" class="label_radio col-lg-6 col-sm-6">
                    <input type="radio" checked="" value="M" id="radio-01" name="gender"> Male
                </label>
                <label for="radio-02" class="label_radio col-lg-6 col-sm-6">
                    <input type="radio" value="F" id="radio-02" name="gender"> Female
                </label>
            </div>

            <p> Enter your account details below</p>
            <input type="text" autofocus="" placeholder="User Name" class="form-control" name="username">
            <input type="password" placeholder="Password" class="form-control" name="password">
            <input type="password" placeholder="Re-type Password" class="form-control" name="rePassword">
            <label class="checkbox">
                <input type="checkbox" value="agree this condition"> I agree to the Terms of Service and Privacy Policy
            </label>
            <button type="submit" class="btn btn-lg btn-login btn-block" formmethod="post">
