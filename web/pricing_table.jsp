                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-lg-3 col-sm-3">
                        <div class="pricing-table">
                            ...
                            <div class="price-actions">
                                <a href=<%="buyService?item=basic"%> methods="get" class="btn">get it now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-3">
                        <div class="pricing-table">
                            ...
                            <div class="price-actions">
                                <a href=<%="buyService?item=starter"%> methods="get" class="btn">get it now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-3">
                        <div class="pricing-table most-popular">
                            ...
                            <div class="price-actions">
                                <a href=<%="buyService?item=premium"%> methods="get" class="btn">get it now</a>
                    ...
                    <div class="col-lg-3 col-sm-3">
                        <div class="pricing-table">
                            ...
                            <div class="price-actions">
                                <a href=<%="buyService?item=enterprise"%> methods="get" class="btn">get it now</a>
                            </div>
                        </div>
                    </div>
                    <!--price end-->
