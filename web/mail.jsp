                ...
                <aside class="mail-nav mail-nav-bg-color">
                    ...
                    <div class="mail-nav-body">
                        <div class="text-center">
                            <a class="btn btn-compose" href="mail_compose.jsp">
                                Compose Mail
                            </a>
                        </div>
                        <ul class="nav nav-pills nav-stacked mail-navigation">
                            <li class="active"><a href="mail.jsp"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-danger pull-right inbox-notification">4</span></a></li>
