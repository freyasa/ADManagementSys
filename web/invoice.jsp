...
<%@ page import="com.exmaple.Entity.ItemAttribute" %>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<%
    ...
    HashMap<String, Integer> userChoices = (HashMap<String, Integer>) session.getAttribute(user.getUsername() + "items");

    int totalItems = userChoices == null ? 0 : userChoices.size();
    int xthTypes = 1;
    int totalDue = 0;
%>
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li><a href="controlling.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    ...
                    <div class="invoice-address">
                        <div class="row">
                            <div class="col-md-5 col-sm-5">
                                ...
                                <%if (totalItems != 0 && userChoices != null) {%>
                                <%for (String s : userChoices.keySet()) {
                                    totalDue += userChoices.get(s) * ItemAttribute.valueOf(s).getMoney();
                                }}%>
                            ...
                            <div class="col-md-4 col-md-offset-3 col-sm-4 col-sm-offset-3">
                                ...
                                <h2 class="amnt-value">$ <%=totalDue%>.00</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <table class="table table-bordered table-invoice">
                    ...
                    <%for (String s : userChoices.keySet()) {%>
                        <tr>
                            ...
                            <td class="text-center"><strong>$ <%=ItemAttribute.valueOf(s).getMoney()%>.00</strong></td>
                            <td class="text-center"><strong><%=userChoices.get(s)%></strong></td>
                            <td class="text-center"><strong>$ <%=userChoices.get(s) * ItemAttribute.valueOf(s).getMoney()%>.00</strong></td>
                        </tr>
                    <%}}%>
...
<%--                    </tr>--%>
            ...
            <div class="text-center ">
                <a class="btn btn-success btn-lg" methods="post" href=<%=totalDue != 0 ? "submitUserItem" : "#"%>><i class="fa fa-check"></i> Submit Invoice </a>
                <a class="btn btn-primary btn-lg" target="_blank" href="invoice_print.jsp"><i class="fa fa-print"></i> Print </a>
            </div>
